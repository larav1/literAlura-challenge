...
public class PrincipalLiteralura {
   ...
   public PrincipalLiteralura(LivroRepository livroRepository, AutorRepository autorRepository){
    ...
    System.out.println("Insira o ano que deseja pesquisar:");
      ...
      List<Autor>buscaAutores=autorRepository.buscarAutoresVivosPorAno(ano);
           ...
           if (!buscaAutores.isEmpty()){
              ...
              System.out.println("Não encontramos nenhum autor que corresponda a sua pesquisa ");
           }
   }
